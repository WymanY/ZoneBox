...
final class L10nTests: XCTestCase {
    ...
    func testConsoleCopy() {
        ...
        XCTAssertEqual(L10n.text(.layoutStripPrevious, language: .english), "Previous layouts")
        XCTAssertEqual(L10n.text(.layoutStripPrevious, language: .chineseSimplified), "上一组布局")
        XCTAssertEqual(L10n.text(.layoutStripNext, language: .english), "Next layouts")
        XCTAssertEqual(L10n.text(.layoutStripNext, language: .chineseSimplified), "下一组布局")
